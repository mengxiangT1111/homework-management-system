...
const routes = [
  ...
  // 学生端
  {
    ...
    children: [
      ...
      { path: 'todos', name: 'StudentTodos', component: () => import('@/views/student/Todos.vue') },
  ...
  // 教师端
  {
    ...
    children: [
      ...
      { path: 'grading/reviews', name: 'TeacherGradingReviews', component: () => import('@/views/teacher/GradingReviews.vue') },
